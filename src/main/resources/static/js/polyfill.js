...
// add metadata on freeze-family methods calling
        ...
        var meta = module.exports = {
            KEY: META, NEED: false, fastKey: fastKey, getWeak: getWeak, onFreeze: onFreeze
        };
    ...
    144: [function (_dereq_, module, exports) {
        ...
        if (_dereq_(58)) {
            ...
            $export($export.S + $export.F * !ALL_CONSTRUCTORS, 'Object', {
                getOwnPropertyDescriptor: $getDesc, defineProperty: $setDesc
            });
            ...
            redefineAll($TypedArrayPrototype$, {
                slice: $slice, set: $set, constructor: function () { /* noop */
                }, toString: arrayToString, toLocaleString: $toLocaleString
            });
            ...
            module.exports = function (KEY, BYTES, wrapper, CLAMPED) {
                ...
                if (FORCED) {
                    TypedArray = wrapper(function (that, data, $offset, $length) {
                        ...
                        hide(that, '_d', {
                            b: buffer, o: offset, l: byteLength, e: length, v: new $DataView(buffer)
                        });
...
// IEEE754 conversions based on https://github.com/feross/ieee754
    ...
    146: [function (_dereq_, module, exports) {
        ...
        module.exports = {
            ABV: ABV, CONSTR: CONSTR, TYPED: TYPED, VIEW: VIEW
        };
...
// "new" creates a new object, old webkit buggy here
    ...
    248: [function (_dereq_, module, exports) {
        ...
        var regexpExec = _dereq_(120);
        _dereq_(62)({
            target: 'RegExp', proto: true, forced: regexpExec !== /./.exec
        }, {
            exec: regexpExec
        });
...
// 21.2.5.3 get RegExp.prototype.flags()
        if (_dereq_(58) && /./g.flags != 'g') _dereq_(99).f(RegExp.prototype, 'flags', {
            configurable: true, get: _dereq_(66)
        });
